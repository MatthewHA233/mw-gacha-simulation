...
function App() {
  ...
  const [gameState, setGameState] = useState({
    ...
    rareCount: 0,
    history: [],
    epicLegendaryHistory: [], // 史诗/传说抽取记录 [{item, drawNumber}]
    items: [...defaultItems]
  })
